    ...
    class Mean_Filter
    {
        public static Bitmap Handle(Bitmap Source_Image, int Mask_Size)
        {
            ...
            for (int Index_Height = 0; Index_Height < Image_Height; Index_Height++)
            {
                ...
                {
                    Count_Mean(Padding_pixel, Source_Pixel, Index_Height, Index_Width, Mask_Size);
                }
            }
        ...
        private static void Count_Mean(int[,,] Padding_Pixel, int[,,] Source_Pixel, int Image_Height, int Image_Width, int Mask_Size)
        {
            int Edge_Size = (Mask_Size - 1) / 2;
            for (int Index_RGB = 0; Index_RGB < 3; Index_RGB++)
            {
                ...
                for (int Index_Mask_Width =0; Index_Mask_Width < Mask_Size; Index_Mask_Width++)
                    for (int Index_Mask_Hieght =0; Index_Mask_Hieght < Mask_Size; Index_Mask_Hieght++)
                        Sum_Mask += Padding_Pixel[Image_Height + Index_Mask_Hieght, Image_Width + Index_Mask_Width, Index_RGB];
                Source_Pixel[Image_Height, Image_Width, Index_RGB] = Sum_Mask / (Mask_Size * Mask_Size);
            }
        }
